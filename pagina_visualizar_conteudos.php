...
<head>
    <!--   GERAL       -->
    <meta charset="UTF-8">
    <title>SAPE - Visualizar Conteúdos</title>
...
?>
    ...
    <div class="container-fluid">
        ...
        <div class="tabela_visualizar">
            ...
            <form method="POST" action="pagina_visualizar_conteudos.php">
                ...
                <?php 
                    ...
                    if(isset($_POST['selecionar']))  {
                        ...
                        foreach($_POST['selecionar'] as $codigo){
                            ...
                            $sql="delete FROM conteudo WHERE idConteudo=$codigo;";
                    ...
                    if (isset($_GET['a'])) {
                        ...
                        if ($a == "buscar") {
                            ...
                            $sqlBusca = "SELECT * FROM conteudo WHERE nomeConteudo LIKE '".$palavra."%' OR materiaConteudo LIKE '".$palavra."%' OR idConteudo LIKE '".$palavra."%' ORDER BY nomeConteudo ASC";
                    ...
                    // Se o botão de pesquisar não foi clicado, ele faz a busca comum e traz todos os dados    
                        ...
                        $sqlBusca = "SELECT idConteudo, nomeConteudo, linkConteudo, materiaConteudo FROM conteudo ORDER BY nomeConteudo ASC";
                    }
                    ...
                    if (mysqli_affected_rows($conn)> 0) {
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope='col'style='width: 200px;'>Conteúdo</th>
                                <th scope='col' style='width: 200px;'>Link de Recomendação</th>
                                <th scope='col' style='width: 200px;'>Matéria do Conteúdo</th>
                                <th scope='col' style='width: 200px;'>Editar</th>
                                <th scope='col' style='width: 200px;'>Excluir</th>
                            </tr>            
                        </thead>"; 
                        ...
                        while($dado = mysqli_fetch_row($result)){ 
                            ...
                            $vnome=$dado[1];
                            $vlink=$dado[2];
                            $vmateriaconteudo=$dado[3];

                            echo "<tbody>";
                            echo "<tr>";
                            echo "<td>" . $vcodigo . "</td>";
                            echo "<td>" . $vnome . "</td>";   
                            echo "<td> <a href='" .  $vlink . "'>" . $vlink ."</a> </td>";   
                            echo "<td>" . $vmateriaconteudo . "</td>";   
                            echo "<td> 
                                    <a href='pagina_edita_conteudo?idConteudo=$vcodigo'id='btn-editar' class='btn btn-info btn-sm' title='Editar' value='editar' name='codigo'>Editar</a> 
                                    </td>";
                            echo "<td> 
