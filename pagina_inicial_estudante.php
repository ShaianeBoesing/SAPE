    ...
    <div class="container">
        ...
        <div class="container-roteiro">
            ...
            if($linhasAfetadas>0){
                ...
                $sqlBuscaSemana= "SELECT idRoteiro, idQuestao, semana, roteiroRespondido FROM roteiro WHERE idJornada=$idJornada ORDER BY idRoteiro";
                ...
                while($dadosBuscaSemana = mysqli_fetch_assoc($resultBuscaSemana)){
                    ...
                    if($idRoteiro != $idUsado && $roteiroRespondido == FALSE){
                    echo "<div class='col-sm-3'>
                        ...
                        <div class='corpoRoteiro'>
                            <a href='pagina_responde_roteiro?idRoteiro=$idRoteiro'id='btn-responder' title='responder' value='responder' name='responderRoteiro'> 
                ...
                echo "<div class='vazio'>
                        <label> Não existem roteiros ainda. Crie sua Jornada primeiro! </label>
                    </div>";
