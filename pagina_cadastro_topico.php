...
<head>
    <!--   GERAL       -->
    <meta charset="UTF-8">
    <title>SAPE - Cadastrar Tópico</title>
    ...
    <link rel="stylesheet" href="css/pagina_cadastro_topico.css">
...
?>
    ...
    <div class="container-fluid">
        <form method="POST" action="processa_cadastro_topico.php">
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <input type="text" name="nome_topico" class="form-control" id="input-nome-topico" placeholder="Digite o nome do tópico">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="dropdown">
                            ...
                            <select name="conteudo_topico" id="select-dropdown-conteudo-topico" class="btn btn-outline-info dropdown-toggle font-color">
                                ...
                                <?php 
                                $sql = "SELECT * FROM conteudo ORDER BY nomeConteudo ASC;";
                                $result = mysqli_query($conn, $sql);
                                ...
                                <option class="dropdown-item" type="button" value="<?php echo $idConteudo;?>"> <?php echo $nomeConteudo; ?>
                                </option>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <input type="url" name="link_topico" class="form-control" id="input-link-topico" placeholder="Informe um link de recomendação">
                    </div>
                </div>
                <p id="mensagem-erro-link"></p>

            </div>
            <button type="submit" class="btn cadastrar" id=botao_cadastrar_topico>Cadastrar</button>
