...
<head>
    <!--   GERAL       -->
    <meta charset="UTF-8">
    <title>SAPE - Visualizar Área</title>
...
?>
    ...
    <div class="container-fluid">
        ...
        <div class="tabela_visualizar">
            ...
            <form method="POST" action="pagina_visualizar_areas.php">
                ...
                <?php 
                    ...
                    if((isset($_POST['f_del'])) && (isset($_POST['selecionar'] ))) {
                        ...
                        foreach($_POST['selecionar'] as $codigo){
                            ...
                            $sql="delete FROM area WHERE idArea=$codigo;";
                    ...
                    if (isset($_GET['a'])) {
                        ...
                        if ($a == "buscar") {
                            ...
                            $sqlBusca = "SELECT * FROM area WHERE nomeArea LIKE '".$palavra."%' OR idArea LIKE '".$palavra."%' ORDER BY nomeArea ASC";
                    ...
                    // Se o botão de pesquisar não foi clicado, ele faz a busca comum e traz todos os dados    
                        ...
                        $sqlBusca = "SELECT * FROM area ORDER BY nomeArea";
                    }
                    ...
                    if (mysqli_affected_rows($conn)> 0) {
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope='col' style='width: 500px;'>Área</th>
                        ...
                        while($dado = mysqli_fetch_row($result)){ 
                            ...
                            echo "<td>" . $vnome . "</td>";   
                            echo "<td> 
                                    <a href='pagina_edita_area?idArea=$vcodigo'id='btn-editar' class='btn btn-info btn-sm' title='Editar' value='editar' name='codigo'>Editar</a> 
                                    </td>";
                            echo "<td> 
