...
<head>
    <!--   GERAL       -->
    <meta charset="UTF-8">
    <title>SAPE - Cadastrar Conteúdo</title>
...
<body>
    ...
    <div class="container-fluid">
        <form method="POST" action="processa_cadastro_conteudo.php">
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <input type="text" name="nome_conteudo" class="form-control" id="input-nome-conteudo" placeholder="Digite o nome do conteúdo">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="dropdown">
                            ...
                            <select name="materia_conteudo" id="select-dropdown-materia-conteudo" class="btn btn-outline-info dropdown-toggle font-color">
                                ...
                                <?php 
                                $sql = "SELECT * FROM materia ORDER BY nomeMateria ASC;";
                                $result = mysqli_query($conn, $sql);
                                ...
                                <option class="dropdown-item" type="button" value="<?php echo $idMateria;?>"> <?php echo $nomeMateria; ?>
                                </option>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <input type="url" name="link_conteudo" class="form-control" id="input-link-conteudo" placeholder="Digite o link de recomendação do conteúdo">
                    </div>
                </div>
            ...
            <button type="submit" class="btn cadastrar" id="botao_cadastrar_conteudo" value="Enviar">Cadastrar</button>
