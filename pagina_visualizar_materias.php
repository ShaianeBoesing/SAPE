...
<head>
    <!--   GERAL       -->
    <meta charset="UTF-8">
    <title>SAPE - Visualizar Matérias</title>
...
?>
    ...
    <div class="container-fluid">
        ...
        <div class="tabela_visualizar">
            ...
            <form method="POST" action="pagina_visualizar_materias.php">
                ...
                <?php 
                    ...
                    if(isset($_POST['selecionar']))  {
                        ...
                        foreach($_POST['selecionar'] as $codigo){
                            ...
                            $sql="delete FROM materia WHERE idMateria=$codigo;";
                    ...
                    if (isset($_GET['a'])) {
                        ...
                        if ($a == "buscar") {
                            ...
                            $sqlBusca = "SELECT * FROM materia WHERE nomeMateria LIKE '".$palavra."%' OR areaMateria LIKE '".$palavra."%' OR idMateria LIKE '".$palavra."%' ORDER BY nomeMateria ASC";
                    ...
                    // Se o botão de pesquisar não foi clicado, ele faz a busca comum e traz todos os dados    
                        ...
                        $sqlBusca = "SELECT idMateria, nomeMateria, areaMateria FROM materia ORDER BY nomeMateria";
                    }
                    ...
                    if (mysqli_affected_rows($conn)> 0) {
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope='col' style='width: 200px;'>Matéria</th>
                                <th scope='col' style='width: 400px;'>Área da Matéria</th>
                        ...
                        while($dado = mysqli_fetch_row($result)){ 
                            ...
                            echo "<td>" . $vcodigo . "</td>";
                            echo "<td >" . $vnome . "</td>";   
                            echo "<td>" . $vareamateria . "</td>";   
                            echo "<td> 
                                    <a href='pagina_edita_materia?idMateria=$vcodigo'id='btn-editar' class='btn btn-info btn-sm' title='Editar' value='editar' name='codigo'>Editar</a> 
                                </td>";
                            echo "<td>
