...
<head>
    <!--   GERAL       -->
    <meta charset="UTF-8">
    <title>SAPE - Visualizar Tópicos</title>
...
?>
    ...
    <div class="container-fluid">
        ...
        <div class="tabela_visualizar">
            ...
            <form method="POST" action="pagina_visualizar_topicos.php">
                ...
                <?php 
                    ...
                    if(isset($_POST['selecionar']))  {
                        ...
                        foreach($_POST['selecionar'] as $codigo){
                            ...
                            $sql="delete FROM topico WHERE idTopico=$codigo;";
                    ...
                    if (isset($_GET['a'])) {
                        ...
                        if ($a == "buscar") {
                            ...
                            $sqlBusca = "SELECT * FROM topico WHERE nomeTopico LIKE '".$palavra."%' OR conteudoTopico LIKE '".$palavra."%' OR idTopico LIKE '".$palavra."%' ORDER BY nomeTopico ASC";
                    ...
                    // Se o botão de pesquisar não foi clicado, ele faz a busca comum e traz todos os dados    
                        ...
                        $sqlBusca = "SELECT idTopico, nomeTopico, linkTopico, conteudoTopico FROM topico ORDER BY nomeTopico";
                    }
                    ...
                    if (mysqli_affected_rows($conn)> 0) {
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope='col'style='width: 200px;' >Tópico</th>
                                <th scope='col' style='width: 200px;'>Link de Recomendação</th>
                                <th scope='col' style='width: 200px;'>Conteúdo do Tópico</th>
                        ...
                        while($dado = mysqli_fetch_row($result)){ 
                            ...
                            echo "<td>" . $vconteudotopico . "</td>";   
                            echo "<td> 
                                    <a href='pagina_edita_topico?idTopico=$vcodigo'id='btn-editar' class='btn btn-info btn-sm' title='Editar' value='editar' name='codigo'>Editar</a> 
                                    </td>";;
                            echo "<td>
